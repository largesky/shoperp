...
{
    class PinduoduoGoodsPropertyMap
    {
        ...
        private static List<PinduoduoGoodsPropertyMap> maps = null;

        static PinduoduoGoodsPropertyMap()
        {
            maps = new List<PinduoduoGoodsPropertyMap>();

            //映射中，前面是拼多多，后面是淘宝或者天猫
            var map = new PinduoduoGoodsPropertyMap { MapTo = 6, Description = "天猫", GoodsType = "靴子", Content = new Dictionary<string, string>() };
            ...
            map = new PinduoduoGoodsPropertyMap { MapTo = 1, Description = "淘宝", GoodsType = "靴子", Content = new Dictionary<string, string>() };
            map.Content.Add("品牌", "品牌");
            map.Content.Add("闭合方式", "闭合方式");
            map.Content.Add("鞋面材质", "帮面材质");
            map.Content.Add("跟底款式", "跟底款式");
        ...
        public static string GetMapPropertyNameByKey(PopType popType, string goodsType, string key)
        {
            ...
            if (map == null)
            {
                throw new Exception("未能找到对应的映射关系");
            }
