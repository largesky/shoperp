...
namespace ShopErp.Domain
{
    public class SystemNames
    {
        ...
        public const string CONFIG_PRINTSERVERADD_CAINIAO = "CONFIG_PRINTSERVERADD_CAINIAO";
        public const string CONFIG_PRINTSERVERADD_PDD = "CONFIG_PRINTSERVERADD_PDD";
